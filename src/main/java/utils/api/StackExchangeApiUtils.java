...
public class StackExchangeApiUtils extends ApiUtils{
    ...
    public static Response getAnswers(String site, String page, String pageSize,
                                      String order, String sort, String filter, ContentType contentType) {
        return doGet(VERSION.getVersion().concat(ANSWERS.getPoint()).
                ...
                concat(SORT.getParameter(sort)).concat(FILTER.getParameter(filter)), contentType);
    }
}
